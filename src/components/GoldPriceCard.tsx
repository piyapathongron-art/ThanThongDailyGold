      ...
      <div className="space-y-6 md:space-y-12 2xl:space-y-16">
        <div className="space-y-2 md:space-y-4">
          <div className="flex justify-between items-baseline">
            <p className="text-sm md:text-xl xl:text-2xl 2xl:text-4xl uppercase tracking-[0.2em] text-white/60 font-bold">รับซื้อ</p>
            <p className="text-base md:text-2xl xl:text-3xl 2xl:text-5xl text-white/60 font-bold">บาทละ</p>
          </div>
        ...
        <div className="space-y-2 md:space-y-4">
          <div className="flex justify-between items-baseline">
            <p className="text-sm md:text-xl xl:text-2xl 2xl:text-4xl uppercase tracking-[0.2em] text-white/60 font-bold">ขายออก</p>
            <p className="text-base md:text-2xl xl:text-3xl 2xl:text-5xl text-white/60 font-bold">บาทละ</p>
          </div>
          <div className="flex items-baseline justify-end gap-2 md:gap-4">
